...
(function() {
  ...
  exportObj.translations['简体中文'] = {
    ...
    ui: {
      ...
      upgradePlaceholder: function(translator, language, slot) {
        return "无 " + (translator(language, 'slot', slot));
      },
  ...
  exportObj.cardLoaders['简体中文'] = function() {
    ...
    upgrade_translations = {
      ...
      "Slave I (Separatist)": {
        ...
        text: "在你执行一次【正面范围】攻击时，如果你在该防御者的【后方范围】，你可以选择将1个【命中】结果改为1个【暴击】结果。添加%GUNNER%槽位。"
      },
...
//# sourceMappingURL=translations-zh.js.map
